...
--test.tsa-ad-type residual --test.tsa-ad-form matrix --test.tsa-opt alpha+beta --test.tsa-init eye --test.mode sdl --data.test mscoco aircraft cifar10 dtd cifar100 cu_birds ilsvrc_2012  --out.method ensemble2 --test.size 600
